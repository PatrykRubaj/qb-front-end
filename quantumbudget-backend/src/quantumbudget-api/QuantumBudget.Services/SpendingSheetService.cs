...
namespace QuantumBudget.Services
{
    public class SpendingSheetService
    {
        ...
        private void AddIncomesSection(IList<IncomeDto> incomes)
        {
            AddIncomeHeader();
        ...
        private void AddCategorySection(string categoryName, IEnumerable<SubcategoryDto> subcategories, bool isLast = false)
        {
