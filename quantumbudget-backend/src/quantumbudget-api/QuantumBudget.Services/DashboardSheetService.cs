...
namespace QuantumBudget.Services
{
    public class DashboardSheetService
    {
        ...
        private readonly List<Model.DTOs.GoogleSpreadsheet.DashboardSubcategoryRowDto> _subcategoryRows;
        ...
        private void AddCategoriesSections(IList<CategoryDto> categories, IList<SubcategoryDto> subcategories)
        {
        ...
        private void AddCategorySection(CategoryDto category, IEnumerable<SubcategoryDto> subcategories)
        {
            ...
            foreach (var sub in subcategories)
            {
                ...
                _subcategoryRows.Add(new Model.DTOs.GoogleSpreadsheet.DashboardSubcategoryRowDto(sub.Id, sub.CategoryId, _googleSheetService.CurrentRow));
