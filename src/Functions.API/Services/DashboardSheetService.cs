...
namespace Services
{
    public class DashboardSheetService
    {
        ...
        private readonly List<Functions.Model.DTOs.GoogleSpreadsheet.DashboardSubcategoryRow> _subcategoryRows;
        ...
        public DashboardSheetService(Budget budget)
        {
            ...
            _subcategoryRows = new List<Functions.Model.DTOs.GoogleSpreadsheet.DashboardSubcategoryRow>();
        ...
        private void AddCategorySection(Category category, IEnumerable<Subcategory> subcategories)
        {
            ...
            foreach (var sub in subcategories)
            {
                ...
                _subcategoryRows.Add(new Functions.Model.DTOs.GoogleSpreadsheet.DashboardSubcategoryRow(sub.Id, sub.CategoryId, _googleSheetService.CurrentRow));
